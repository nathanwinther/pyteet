...
INIT_APP_PY = '''from pyteet import Pyteet
...
INIT_HOME_CONTROLLER = '''from pyteet.utils import send_json
...
MAKE_LONG_DESC = '''Create a new resource
...
MAKE_CONTROLLER = '''from pyteet.utils import send_json
...
PAT_MYSQL = """from pyteet.database import database
...
PAT_POSTGRES = """from pyteet.database import database
...
PAT_SQLITE = """from pyteet.database import database
...
MAKE_MIGRATION = """from pyteet.database import database
...
MAKE_MODEL = '''from pyteet.model import Model
...
MIGRATE_LONG_DESC = '''Database migration commands
...
def get_commands() -> dict:
    ...
    for file in path.iterdir():
        ...
        try:
            cls_name = snake_to_camel(file.stem)
